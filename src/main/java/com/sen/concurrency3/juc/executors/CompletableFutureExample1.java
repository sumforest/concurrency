 ...
 * @Description: {@link CompletableFuture} 解决{@link Future} 不能先返回先完成的结果和不能回调的缺点。
 */
public class CompletableFutureExample1 {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        //CompletableFuture维护的线程池的线程默认是守护线程维护的线程池的线程默认是守护线程，
        // 所以main线程退出后其自身也退出
        ...
        executorService.invokeAll(callableList)
                ...
                .parallel()
                .forEach(CompletableFutureExample1::display);
        System.out.println("===========over===========");*/
